package supriyadiericsonsinaga.com.tugas_uas_akb_10118343_if8.adapter;
...
import supriyadiericsonsinaga.com.tugas_uas_akb_10118343_if8.maps.MapsWisata3Activity;
import supriyadiericsonsinaga.com.tugas_uas_akb_10118343_if8.maps.MapsWisata4Activity;
...
public class Wisata4Adapter extends RecyclerView.Adapter<Wisata4Adapter.ViewHolder> {
    ...
    public Wisata4Adapter(Context context, ArrayList<Wisata4> wisata4s){
        ...
        ref = FirebaseDatabase.getInstance("https://uas-akb-10118343-if8-default-rtdb.asia-southeast1.firebasedatabase.app")
